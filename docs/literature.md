...
| Ao, Chen and Simchi-Levi, [Prediction-Guided Active Experiments](https://arxiv.org/abs/2411.12036) | Adaptive outcome acquisition and efficiency | Abstract screened; necessary next full-text comparison |
...
| Cherep et al., [ABxLab](https://arxiv.org/abs/2509.25609) | Controlled interface interventions on agent choices | Abstract and authors' repository screened |
